...
import sys
from Package import *
# from Package.DB_select import DB_select as select
# from Package.DB_insert import DB_insert as insert
# from Package.DB_update import DB_update as update
# from Package.DB_delete import DB_delete as delete
# from Package.mkdir import mkdir


# filter 파일과 mkdir 파일이 같은 선상에 존재하지 않아서 아래 방식을 이용해서 임포트
# 참고 사이트 : https://brownbears.tistory.com/296
# sys.path.append(os.path.dirname(os.path.dirname(__file__)))
# from cv_env import mkdir



# sys.path.append(os.path.dirname(os.path.abspath(os.path.dirname(__file__))))
# from MYSQL import DB_insert as insert
...
# sys.path.append(os.path.dirname(os.path.abspath(os.path.dirname(__file__))))
# from MYSQL.DB_update import update
# sys.path.append(os.path.dirname(os.path.abspath(os.path.dirname(__file__))))
# from MYSQL.DB_delete import delete
...
# filter('mosaic_not_auto', 'C:/Users/Photocate/친구들이랑/2022-12-07/place-none/KakaoTalk_20230522_202510715_29.jpg', '친구들이랑', 'sj')
